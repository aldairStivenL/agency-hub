...
const handleEmailLogin = async (e: React.FormEvent) => {
  ...
  const problems = [
    {
      ...
      title: "Caos Manual",
      description:
        "Gestión por WhatsApp, screenshots desorganizados y sin estructura",
  ...
  const solutionFeatures = [
    {
      ...
      description:
        "Toda la información de tus streamers en un solo lugar. Acceso instantáneo a métricas críticas.",
      color: "#00ffff",
    },
    {
      icon: Brain,
      ...
      description:
        "Algoritmo avanzado que recomienda batallas óptimas para maximizar ingresos automáticamente.",
      color: "#ff0080",
    },
    {
      icon: Zap,
      ...
      description:
        "Reduce trabajo manual en un 80%. Monitoreo 24/7 sin intervención humana constante.",
      color: "#0080ff",
    },
    {
      icon: CheckCircle2,
      ...
      description:
        "Datos actualizados al instante para tomar decisiones informadas al momento.",
      color: "#00ff88",
    },
  ];
  ...
  const benefits = [
    {
      ...
      title: "Más Ingresos",
      description:
        "Aumenta tus ganancias hasta 300% con recomendaciones de batallas inteligentes.",
      stat: "+300%",
      color: "#ff0080",
    },
    {
      ...
      description:
        "Reduce trabajo manual en 80%. Dedica tu tiempo a crecer, no a gestionar.",
      stat: "-80%",
      color: "#00ffff",
    },
    {
      ...
      description:
        "Datos en tiempo real para decisiones estratégicas respaldadas por IA.",
      stat: "24/7",
      color: "#0080ff",
    },
    {
      ...
      description:
        "Gestiona 10, 100 o 1000 streamers sin aumentar tu carga operativa.",
      stat: "∞",
      color: "#00ff88",
    },
  ];
  ...
  const comparisonRows = [
    {
      metric: "Tiempo de gestión semanal",
      before: "40 horas",
      after: "8 horas",
    },
  ...
  const featureCards = [
    {
      ...
      description:
        "Gestiona todos tus streamers en un único dashboard. Ve performance, ganancias y estadísticas en tiempo real.",
      color: "#ff0080",
    },
    {
      icon: Activity,
      ...
      description:
        "Monitorea batallas en tiempo real. Recibe alertas cuando hay oportunidades para optimizar.",
      color: "#00ffff",
    },
    {
      icon: Zap,
      ...
      description:
        "El algoritmo sugiere matchups óptimos basado en histórico, horarios y tendencias actuales.",
      color: "#0080ff",
    },
    {
      icon: BarChart3,
      ...
      description:
        "Reportes profundos sobre desempeño, ingresos, tasas de ganancia y métricas clave de cada streamer.",
      color: "#00ff88",
    },
    {
      icon: Cpu,
      ...
      description:
        "La inteligencia artificial trabaja 24/7 optimizando estrategias sin intervención manual constante.",
      color: "#ff8800",
    },
    {
      icon: Bell,
      ...
      description:
        "Recibe alertas cuando hay oportunidades críticas. Nunca pierdas una batalla importante.",
      color: "#ff00ff",
    },
  ];
  ...
  const stats = [
    ...
    {
      number: "1,000+",
      label: "Streamers Gestionados",
      color: "#00ffff",
      icon: TrendingUp,
    },
    {
      number: "$10M+",
      label: "En Ganancias Generadas",
      color: "#0080ff",
      icon: Star,
    },
  ];
  ...
  const testimonials = [
    {
      ...
      content:
        "Agency Hub cambió completamente mi operación. Pasé de gestionar 5 streamers a 50 sin aumentar mi equipo.",
      color: "#ff0080",
    },
    {
      ...
      content:
        "Las recomendaciones de batallas son increíbles. Aumentamos ingresos 300% en solo 3 meses.",
      color: "#00ffff",
    },
    {
      ...
      content:
        "Es como tener un analista de datos 24/7 trabajando sin costo. Inversión que se paga sola.",
      color: "#0080ff",
    },
  ];
      ...
      <section className="relative min-h-screen flex items-center justify-center px-4 sm:px-6 lg:px-8 overflow-hidden">
        ...
        <div className="relative z-10 max-w-5xl mx-auto text-center">
          ...
          <p className="text-lg sm:text-xl text-gray-300 mb-10 max-w-3xl mx-auto leading-relaxed">
            Centraliza la gestión de tus streamers, optimiza batallas
            inteligentes y maximiza ingresos. Todo en una plataforma diseñada
            para agencias modernas.
          </p>

          <p className="text-lg sm:text-xl text-gray-300 mb-10 max-w-3xl mx-auto leading-relaxed">
            Centraliza la gestión de tus streamers, optimiza batallas
            inteligentes y maximiza ingresos.
...
>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 mt-16">
            <div className="text-center">
              <div className="text-3xl font-bold text-[#00ffff] mb-2">300%</div>
              <p className="text-gray-400 text-sm">Incremento en eficiencia</p>
            </div>
            <div className="text-center">
              <div className="text-3xl font-bold text-[#ff0080] mb-2">24/7</div>
              <p className="text-gray-400 text-sm">Monitoreo inteligente</p>
            </div>
            <div className="text-center">
              <div className="text-3xl font-bold text-[#0080ff] mb-2">
                Real-time
              </div>
              <p className="text-gray-400 text-sm">Datos en vivo</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="relative z-10 max-w-6xl mx-auto">
          <div className="text-center mb-16 sm:mb-20">
            <h2 className="text-4xl sm:text-5xl font-bold mb-6 text-white text-balance">
              El Problema de las{" "}
              <span className="text-[#ff0080]">Agencias Modernas</span>
            </h2>
            <p className="text-lg text-gray-300 max-w-2xl mx-auto">
              Las agencias de TikTok Live enfrentan caos operativo, falta de
              datos y pérdida de ingresos potenciales.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8">
            {problems.map(p => {
              ...
              return (
                <div
                  key={p.title}
                  className="group relative p-8 rounded-xl border border-[#2d3247] bg-[#1a1f3a]/40 backdrop-blur hover:bg-[#1a1f3a]/60 transition-all duration-300"
                >
                  <div
                    className={`absolute inset-0 rounded-xl bg-gradient-to-r ${p.color} opacity-0 group-hover:opacity-20 transition-opacity pointer-events-none`}
                  />
                  <div className="relative z-10">
                    <div
                      className={`inline-flex p-3 rounded-lg bg-gradient-to-br ${p.color} mb-4`}
                    >
          ...
          <div className="mt-16 p-8 rounded-xl border border-[#ff0080]/30 bg-[#ff0080]/5 backdrop-blur text-center">
            ...
            <p className="text-gray-300">
              Las agencias pierden hasta un 40% de ingresos potenciales por
              falta de optimización inteligente.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="relative py-20 sm:py-32 px-4 sm:px-6 lg:px-8 overflow-hidden">
        ...
        <div className="relative z-10 max-w-6xl mx-auto">
          <div className="text-center mb-16 sm:mb-20">
            ...
            <p className="text-lg text-gray-300 max-w-2xl mx-auto">
              Una plataforma completa diseñada específicamente para agencias de
              TikTok Live que necesitan crecer y escalar rápidamente.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-16">
            {solutionFeatures.map(f => {
              ...
              return (
                <div
                  key={f.title}
                  className="group p-8 rounded-xl border border-[#2d3247] bg-[#1a1f3a]/40 backdrop-blur hover:bg-[#1a1f3a]/60 transition-all duration-300 hover:shadow-[0_0_30px_rgba(0,255,255,0.2)]"
                >
            ...
            <div className="relative z-10 max-w-3xl mx-auto">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="text-2xl font-bold text-white">
                  Algoritmo de Batallas Inteligente
                </h3>
              </div>
              <p className="text-gray-300 mb-6 leading-relaxed">
                Nuestro motor de IA analiza en tiempo real:
              </p>
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                {[
                  {
                    label: "Rendimiento",
                    desc: "Historial completo de cada streamer",
                    color: "#00ffff",
                  },
                  {
                    label: "Compatibilidad",
                    desc: "Matchups óptimos entre rivales",
                    color: "#ff0080",
                  },
                  {
                    label: "ROI",
                    desc: "Maximización de ingresos esperados",
                    color: "#0080ff",
                  },
                ].map(item => (
                  <div
                    key={item.label}
                    className="p-4 rounded-lg bg-[#1a1f3a]/50"
      ...
      <section className="relative py-20 sm:py-32 px-4 sm:px-6 lg:px-8 overflow-hidden">
        ...
        <div className="relative z-10 max-w-6xl mx-auto">
          <div className="text-center mb-16 sm:mb-20">
            <h2 className="text-4xl sm:text-5xl font-bold mb-6 text-white text-balance">
              Beneficios que <span className="text-[#ff0080]">Transforman</span>{" "}
              tu Negocio
            </h2>
            <p className="text-lg text-gray-300 max-w-2xl mx-auto">
              Los resultados que nuestros clientes experimentan en los primeros
              meses.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {benefits.map(b => {
              ...
              return (
                <div
                  key={b.title}
                  className="group relative p-8 rounded-xl border border-[#2d3247] bg-[#1a1f3a]/40 backdrop-blur hover:bg-[#1a1f3a]/60 transition-all duration-300 overflow-hidden"
                >
                  <div
          ...
          <div className="mt-16 sm:mt-20 rounded-xl border border-[#2d3247] bg-[#1a1f3a]/40 backdrop-blur overflow-hidden">
            <div className="p-8">
              <h3 className="text-2xl font-bold text-white mb-8 text-center">
                Antes vs Después de Agency Hub
              </h3>
                ...
                <table className="w-full">
                  <thead>
                    <tr className="border-b border-[#2d3247]">
                      ...
                      <th className="text-center py-4 px-4 font-bold text-[#ff0080]">
                        Antes
                      </th>
                      <th className="text-center py-4 px-4 font-bold text-[#00ffff]">
                        Después
                      </th>
                    </tr>
                  </thead>
                  <tbody>
                    {comparisonRows.map(row => (
                      <tr
                        key={row.metric}
                        className="border-b border-[#2d3247]/50 hover:bg-[#2d3247]/20"
                      >
                        <td className="py-4 px-4 text-gray-300">
                          {row.metric}
                        </td>
                        <td className="text-center py-4 px-4 text-[#ff0080] font-semibold">
                          {row.before}
                        </td>
                        <td className="text-center py-4 px-4 text-[#00ffff] font-semibold">
                          {row.after}
                        </td>
                      </tr>
                    ))}
        ...
        <div className="relative z-10 max-w-6xl mx-auto">
          <div className="text-center mb-16 sm:mb-20">
            <h2 className="text-4xl sm:text-5xl font-bold mb-6 text-white text-balance">
              ...
              <span className="text-[#00ffff]">Empoderan</span>
            </h2>
            <p className="text-lg text-gray-300 max-w-2xl mx-auto">
              Todas las herramientas que necesitas para gestionar, optimizar y
              crecer tu agencia de TikTok Live.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {featureCards.map(f => {
              ...
              return (
                ...
                >
                  <div
                    className="absolute inset-0 rounded-xl opacity-0 group-hover:opacity-20 transition-opacity pointer-events-none blur-xl"
                    style={{ backgroundColor: f.color }}
                  />
                  <div className="relative z-10">
                    <div
                      className="p-4 rounded-lg inline-block mb-4 group-hover:scale-110 transition-transform"
                      style={{ backgroundColor: f.color + "20" }}
                    >
                      <Icon className="w-6 h-6" style={{ color: f.color }} />
                    </div>
          ...
          <div className="mt-16 p-12 rounded-xl border border-[#00ffff]/30 bg-gradient-to-br from-[#1a1f3a]/60 via-[#0080ff]/10 to-[#1a1f3a]/60 backdrop-blur">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-4">
              {[
                ...
                <div
                  key={tool}
                  className="p-4 rounded-lg border border-[#2d3247] bg-[#1a1f3a]/50 text-center hover:border-[#00ffff]/50 transition-colors"
                >
      ...
      <section className="relative py-20 sm:py-32 px-4 sm:px-6 lg:px-8 overflow-hidden">
        ...
        <div className="relative z-10 max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-20 sm:mb-24">
            {stats.map(s => {
              ...
              return (
                <div
                  key={s.label}
                  className="group relative p-10 rounded-xl border border-[#2d3247] bg-[#1a1f3a]/40 backdrop-blur hover:bg-[#1a1f3a]/60 transition-all duration-300 text-center"
                >
                  <div
          ...
          <h2 className="text-4xl sm:text-5xl font-bold text-center mb-16 text-white text-balance">
            ...
            <span className="text-[#ff0080]">Clientes</span>
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {testimonials.map(t => (
              ...
              >
                <div
                  className="absolute top-0 left-0 right-0 h-1 rounded-t-xl group-hover:h-2 transition-all"
          ...
          <div className="mt-20 p-8 rounded-xl border border-[#2d3247] bg-[#1a1f3a]/40 backdrop-blur">
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-8 text-center">
              ...
              <div>
                <div className="text-3xl font-bold text-[#ff0080] mb-2">
                  99.9%
                </div>
                <p className="text-gray-400 text-sm">Uptime de la plataforma</p>
              </div>
              <div>
                <div className="text-3xl font-bold text-[#0080ff] mb-2">
                  24/7
      ...
      <section className="relative py-20 sm:py-32 px-4 sm:px-6 lg:px-8 overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto text-center">
          ...
          <p className="text-lg sm:text-xl text-gray-300 mb-12 leading-relaxed max-w-2xl mx-auto">
            Únete a más de 50 agencias que ya están usando Agency Hub para
            crecer exponencialmente. Empieza tu prueba gratuita hoy mismo, sin
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-8 text-sm text-gray-400">
            {[
              ...
              <div key={item.text} className="flex items-center gap-2">
                {i > 0 && (
                  <div className="hidden sm:block w-px h-6 bg-[#2d3247]" />
                )}
                <div
                  className="w-2 h-2 rounded-full"
              ...
              {[
                ...
                <details key={faq.q} className="group">
                  <summary className="flex items-center justify-between cursor-pointer text-white font-semibold hover:text-[#00ffff] transition-colors">
                    <span>{faq.q}</span>
                    <span className="text-[#00ffff] group-open:rotate-180 transition-transform">
                      ▼
                    </span>
                  </summary>
      ...
      <footer className="relative border-t border-[#2d3247] bg-[#0a0e27] py-16 sm:py-20 px-4 sm:px-6 lg:px-8 overflow-hidden">
        ...
        <div className="relative z-10 max-w-6xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-5 gap-12 mb-12">
            ...
            <div className="col-span-1">
              ...
              <p className="text-gray-400 text-sm mb-6">
                La plataforma definitiva para agencias de TikTok Live en
                Latinoamérica.
              </p>
                ...
                {socialLinks.map(s => {
                  ...
                  return (
                    <a
                      ...
                      href={s.href}
                      aria-label={s.label}
                      className="p-2 rounded-lg bg-[#1a1f3a]/50 border border-[#2d3247] hover:border-[#00ffff]/50 hover:bg-[#1a1f3a]/80 transition-all text-gray-400 hover:text-[#00ffff]"
                    >
                ...
                <ul className="space-y-2">
                  {items.map(item => (
                    <li key={item}>
                      <a
                        href="#"
                        className={`text-gray-400 transition-colors text-sm ${hoverColors[heading]}`}
                      >
                        {item}
                      </a>
                    </li>
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            <p className="text-gray-400 text-sm">
              © {currentYear} Agency Hub. Todos los derechos reservados.
            </p>
            <p className="text-gray-400 text-sm">
              Hecho con amor para agencias latinas
            </p>
          </div>

          <div className="mt-12 p-6 rounded-lg border border-[#2d3247] bg-[#1a1f3a]/40 backdrop-blur text-center">
            <p className="text-white font-semibold mb-2">
              ¿Quieres las últimas actualizaciones?
            </p>
            <p className="text-gray-400 text-sm">
              Suscríbete a nuestro newsletter para recibir tips, actualizaciones
          ...
          <div className="relative w-full max-w-md p-8 rounded-2xl border border-[#00ffff]/30 bg-[#1a1f3a] shadow-2xl text-white">
            ...
            <div className="relative flex items-center justify-center mb-6">
              <div className="absolute inset-0 flex items-center">
                <div className="w-full border-t border-[#2d3247]"></div>
              </div>
              <span className="relative px-3 bg-[#1a1f3a] text-xs text-gray-500 uppercase">
                o
              </span>
            </div>
